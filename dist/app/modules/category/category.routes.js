...
router.delete('/:id', (0, auth_1.default)(user_interface_1.UserRole.ADMIN, user_interface_1.UserRole.Landlord), category_controller_1.CategoryController.deleteCategory);

...
router.post('/', (0, auth_1.default)(user_interface_1.UserRole.Tenant), rentalRequest_controller_1.RentalRequestController.createRentalRequest);
...
router.get('/', (0, auth_1.default)(user_interface_1.UserRole.Tenant, user_interface_1.UserRole.ADMIN, user_interface_1.UserRole.Tenant), rentalRequest_controller_1.RentalRequestController.getAllRentalRequest);
